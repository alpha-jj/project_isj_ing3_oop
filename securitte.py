class RegleFirewall:
    ...
    def correspond(self, paquet) -> bool:
        """
        Vérifie si ce paquet satisfait tous les critères de cette règle.
        Retourne True si la règle s'applique, False sinon.
        """
    ...
    def __repr__(self) -> str:
        return f"RegleFirewall(action={self.action!r})"

class JournalSecurite:
    """

    Enregistre chaque décision (BLOQUER / AUTORISER) avec horodatage.
    """
    ...
    def enregistrer(self, action: str, paquet, regle=None):
        ...
        Paramètres :
            ...
            regle   : objet RegleFirewall appliquée (ou None si règle par défaut)
        """
